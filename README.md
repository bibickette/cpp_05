...
*Note : this repository contains only the `cpp_05` module. It is part of the global [cpp_modules](https://github.com/bibickette/cpp_modules) repository, which regroups all C++ modules.*

1. Clone `cpp_05` in a folder first  : `git clone git@github.com:bibickette/cpp_05.git`
